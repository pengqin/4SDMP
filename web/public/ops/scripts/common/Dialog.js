...
define(function(require, exports) {
  ...
  .controller('DialogController', ['$scope', '$timeout', function ($scope, $timeout) {
    ...
    function show() {
      $('#gymDialog').modal('show');
    }
    $('#gymDialog').on('hidden', function () {
      $scope.dialog.shown = false;
    });
    $('#gymDialog').on('shown', function () {
      ...
      $scope.dialog.handler = function() { $('#gymDialog').modal('hide'); };
  		show();
  	};
  ...
  .directive("gymDialog", ['$location', function ($location) {
    return {
      restrict: 'A',
      replace: true,
